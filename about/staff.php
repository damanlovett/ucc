    ...
    <div id="yui-main">
      <div class="yui-b">
        ...
        <div id="secContent" class="yui-g">
          ...
          <div id="tabs">
            <ul>
            	<li class="tabHeader"><a href="#tab-1">Career Counselors</a></li>
                <li class="tabHeader"><a href="#tab-2">Administrative Staff</a></li>
                <li class="tabHeader"><a href="#tab-3">Satellite Career Centers</a></li>
                <li class="tabHeader"><a href="#tab-4">Additional Resources</a></li>
             </ul>
          <div id="tab-1"><table class="basicTable100 tableList">
            <caption>
            Career Counselors
            </caption>
            <tr>
...
<span class="trigger ss_sprite ss_user" title="Bio for Beverly Marchi">&nbsp;</span>                 
    ...
    Leslie Rand-Pickett serves students in the College of Engineering (Computer, Computer Science, Electrical, Integrated Manufacturing Systems, Nuclear, Operations Research). Prior to coming to NC State, Leslie was a Career Counselor at UNC Wilmington. She holds a Master of Education degree in Counselor Education from NC State, and served as the counseling intern in the University Career Center while in graduate school. Additionally, she received an Associate degree from Peace College, and a Bachelor of Arts in Psychology from UNC Chapel Hill. </p>
        ...
        Leslie Bowman serves students in the College of Engineering (Biomedical) and coordinates the externship program. Prior to coming to NC State, she was a Human Resource Manager at a medical device company and worked as an Account Executive for a finance firm. Leslie earned a Bachelor of Arts in Psychology from NC State, a Masters of Arts&nbsp;in Healthcare Administration from UNC Chapel Hill and&nbsp;a Masters of Arts in Counseling from Seton Hall University. </p>
                ...
                <h2>First Year College &amp; Undecided Majors</h2>
                <ul>
            ...
            State. Prior to joining the University Career Center, Woody was in a full-time
            private practice as a professional counselor and worked as a corporate career
            consultant with a major executive consulting firm. Additional professional
            roles have included serving as director of student affairs, a community college
            instructor, and an associate minister in pastoral counseling. He received a
            Bachelor of Arts in English from Carson-Newman College, a Master of Divinity in
            Theology and Counseling from Southeastern Seminary, and a Doctor of Education
            ...
            Management, as the Career Center liaison. In addition, she has organized and
            facilitated Career Direction workshops for students across the University.
            Carol earned her Bachelor of Arts in Spanish Literature at Duke University and
          ...
          <div id="tab-2"><table width="82%" height="156" border=0 cellpadding=0 class="basicTable100 tableList">
            <caption>
          ...
          <div id="tab-4"><table class="basicTable">
            <caption>
...
<tr>
            ...
            <tr>
              ...
              <td> – help with career decisions (one year) after graduation</td>
            </tr>
            <tr>
