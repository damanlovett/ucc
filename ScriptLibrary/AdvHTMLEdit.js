...
// by George Petrov, Patrick Woldberg
//
...
var is_gecko18=(is_gecko&&navigator.productSub>=20051111)
var is_opera=(agt.indexOf("opera/9")!=-1);
if(is_opera){is_ie=true;is_gecko=false;is_firefox=false;}
if(checkBrowser()){
...
var dmxTT,dmxTT_t1,dmxTT_t2,Xpos,Ypos,dmxTT_pEl;
...
if((is_ie&&!is_opera)&&!r)var rt=alert('Error attaching event to form!');
if(rt)return false;
...
contentL+='<a href="javascript:void(0);" style="display:block;text-decoration:none;color:'+config.divColor+';cursor:pointer;border:1px solid #FFFFFF;" onmouseover="this.style.border=\'1px solid #E6EAEB\'" onmouseout="this.style.border=\'1px solid #FFFFFF\'"  '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="'+(is_ie?'parent.':'')+'dmx_f26(\''+objname+'\');'+(is_ie?'parent.':'')+'document.getElementById(\''+dmx_v8+'\').value=\''+fontname+'\' ;'+(is_ie?'parent.':'')+'dmx_f8(\''+dmx_v8+'\'); " ><div id="'+divId+'" class="bla" style="font-size: 12pt; margin: 0px 1px 0px 1px; padding: 2px 2px 2px 5px;  height: auto; font-family:'+config.fontnames[fontname]+'"><nobr>'+fontname+'</nobr></div></a>';
}
...
contentL+='<a href="javascript:void(0);" style="display:block;text-decoration:none;color:'+config.divColor+';cursor:pointer;border:1px solid #FFFFFF;" onmouseover="this.style.border=\'1px solid #E6EAEB\'" onmouseout="this.style.border=\'1px solid #FFFFFF\'"  '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="'+(is_ie?'parent.':'')+'document.getElementById(\''+dmx_v8+'\').value=\''+fontsize+'\';'+(is_ie?'parent.':'')+'dmx_f8(\''+dmx_v8+'\');'+(is_ie?'parent.':'')+'dmx_f26(\''+objname+'\');" ><div id="'+divId+'" class="bla" style="margin: 0px 1px 0px 1px; padding: 2px 2px 2px 5px; height: auto;"><nobr><span class="bla" style="font-size:'+fontsize.substring(3,fontsize.length-4)+'pt;">'+config.fontsizes[fontsize]+'</span>'+fontsize.substring(1+config.fontsizes[fontsize].length)+'</nobr></div></a>';
}
contentList[dmx_v8]=new Array('',contentL);
break;
case'fontstyle':
...
toolbar+='<button id="'+dmx_v8+'_b" onFocus="blur()" style="text-align: center; vertical-align: middle;width:14px; height:16px; margin: 0; padding: 0;" '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="dmx_f26(\''+objname+'\'); dmx_f25(event,\''+dmx_v8+'\', \''+objname+'\');return false;" unselectable="on"><img src="'+config.imgURL+'DP.gif" border=0 unselectable="on" onFocus="blur();" style="text-align: center; vertical-align: middle;" /></button></div>';
var divId='div_fontstyle_0';
contentL+='<a href="javascript:void(0);"  style="display:block;text-decoration:none;color:'+config.divColor+';cursor:pointer;border:1px solid #FFFFFF;" onmouseover="this.style.border=\'1px solid #E6EAEB\'" onmouseout="this.style.border=\'1px solid #FFFFFF\'" '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="'+(is_ie?'parent.':'')+'document.getElementById(\''+dmx_v8+'\').value=\''+locale.getString('@{None}',lang)+'\';'+(is_ie?'parent.':'')+'dmx_f8(\''+dmx_v8+'\');'+(is_ie?'parent.':'')+'dmx_f26(\''+objname+'\');" ><div id="'+divId+'" class="'+null+'" style="margin: 0px 1px 0px 1px; padding: 2px 2px 2px 5px; min-width: 90px; font-size: 12pt; height: auto; max-width: 160px;"> '+locale.getString('@{None}',lang)+'</div></a>\n';
...
var divId='div_fontstyle_'+(i+1);
styleArr[fontstyle.className]=fontstyle.name;
revStyleArr[fontstyle.name]=fontstyle.className;
contentL+='<a href="javascript:void(0);" style="display:block;text-decoration:none;'+config.divColor+';cursor:pointer;border:1px solid #FFFFFF;" onmouseover="this.style.border=\'1px solid #E6EAEB\'" onmouseout="this.style.border=\'1px solid #FFFFFF\'" '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="'+(is_ie?'parent.':'')+'document.getElementById(\''+dmx_v8+'\').value=\''+fontstyle.name+'\';'+(is_ie?'parent.':'')+'dmx_f8(\''+dmx_v8+'\');'+(is_ie?'parent.':'')+'dmx_f26(\''+objname+'\');" ><div id="'+divId+'" class="'+fontstyle.className+'" style="margin: 0px 1px 0px 1px; padding: 2px 2px 2px 5px; min-width: 90px; max-width: 160px;" >'+fontstyle.name+'</div></a>\n';
}
contentList[dmx_v8]=new Array('',contentL);
break;
case'formatblock':
...
contentL+='<a href="javascript:void(0);" style="display:block;text-decoration:none;color:#333333;cursor:pointer;border:1px solid #FFFFFF" onmouseover="this.style.border=\'1px solid #E6EAEB\'" onmouseout="this.style.border=\'1px solid #FFFFFF\'" '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="'+(is_ie?'parent.':'')+'document.getElementById(\''+dmx_v8+'\').value=\''+rules.selectorText.substring(1)+'\' ;'+(is_ie?'parent.':'')+'dmx_f8(\''+dmx_v8+'\');'+(is_ie?'parent.':'')+'dmx_f26(\''+objname+'\');" ><div style="'+divStyle+'; width:100%; margin: 0px 1px 0px 1px; padding: 2px 2px 2px 5px; max-width: 160px;">'+rules.selectorText.substring(1)+'</div></a>\n';
}
k++;
}
}
...
styleArr[rules.selectorText.substring(1)]=rules.selectorText.substring(1);
revStyleArr[rules.selectorText.substring(1)]=rules.selectorText.substring(1);
contentL+='<a href="javascript:void(0);" style="display:block;text-decoration:none;color:'+config.divColor+';cursor:pointer;border:1px solid #FFFFFF" onmouseover="this.style.border=\'1px solid #E6EAEB\'" onmouseout="this.style.border=\'1px solid #FFFFFF\'" '+(is_safari?'onclick="return false;" onmousedown':'onClick')+'="'+(is_ie?'parent.':'')+'document.getElementById(\''+dmx_v8+'\').value=\''+rules.selectorText.substring(1)+'\' ;'+(is_ie?'parent.':'')+'dmx_f8(\''+dmx_v8+'\');'+(is_ie?'parent.':'')+'dmx_f26(\''+objname+'\');" ><div style="'+divStyle+'margin: 0px 1px 0px 1px; padding: 2px 2px 2px 5px; max-width: 160px;">'+rules.selectorText.substring(1)+'</div></a>\n';
}
k++;
}
}
...
function dmxedit_setHTML(objname,newchar){
var dmx_v6=document.getElementById('_'+objname+'_editor');
dmx_v6.contentWindow.document.body.innerHTML=newchar;
}
function dmxedit_getHTML(objname){
var dmx_v6=document.getElementById('_'+objname+'_editor');
return dmx_v6.contentWindow.document.body.innerHTML;
}
...
//if (is_gecko) editdoc.designMode='on';
//Fix firefox having multiple editors
if(is_gecko)setTimeout("var dmx_v6=document.getElementById('_"+objname+"_editor');var dmx_v5=dmx_v6.contentWindow.document;dmx_v5.designMode='on'",100);
//var content = document.getElementById(objname).value;
//Use innerHTML instead of .value to preserve spaces, unfortunately in Firefox 1.5 this is no longer possible, so multiple &nbsp; get stripped there
var content=(is_ie||is_gecko18?document.getElementById(objname).value:document.getElementById(objname).innerHTML);
var html='<html><head>';
if(is_ie){
...
if(is_ie){
dmxTT.oPopup=window.createPopup();
var oPopupBody=dmxTT.oPopup.document.body;
oPopupBody.innerHTML='<div id="dmxPopup" style="width:100%;height:100%;overflow-x:hidden;overflow-y:auto;color:'+config.divColor+'; background-color:'+config.bgColor+'; border: 2px outset #E6EAEB; max-height: 140px;">'+content+'</div>';
dmxTT.el=dmxTT.oPopup.document.getElementById("dmxPopup");
dmxTT.width=160;//getWidth(dmxTT.el);
dmxTT.height=160;//getHeight(dmxTT.el, 1);
dmxTT.oPopup.show(-1,dmxTT_pEl.offsetHeight,dmxTT.width,dmxTT.height,dmxTT_pEl);
}else{
...
if(!config.dmxTT)return;
if(is_ie){if(config.dmxTT.oPopup)config.dmxTT.oPopup.hide();}
else dmxTT_t2=setTimeout('document.getElementById(\''+id+'\').style.overflow = "";'+config.dmxTT.obj+'.hide();',100);
}
}
...
var Atag=/<span class=ccp_tag>(&lt;a([ ]*[\w\=\"\'\.\/\;\:\)\(-\?]*){0,}&gt;)<\/span>/gi;
html=html.replace(Atag,"<span class=ccp_A>$1</span>");
