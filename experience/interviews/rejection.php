...
<div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                ...
                <li class="last">Handling rejection </li>
              </ul>
            </div>
          </div>
          ...
          <ul>
            <li> The
                  job search process is competitive.&nbsp; There are many qualified candidates. </li>
            <li>  You
                  will not be the right candidate for every opportunity (and every
            opportunity will not be the right one for you).     </li>
            <li>Do
                  not take an employer's decision personally.  There are many variables -- some in your control, some out of your
                  control. </li>
            <li>Evaluate
            your performance and make room for improvement. </li>
            <li> If
                  you see a pattern, consult with your <a
href="../../about/staff.php">career counselor</a>. &nbsp; </li>
            <li> Make
                  corrections to your approach as needed. </li>
            <li> Keep
                  your confidence high.  Believe in
                  yourself so that others will too. </li>
            <li>Every student brings their unique strengths.  Be ready to communicate yours. </li>
          </ul>
        </div>
      </div>
    </div>
