    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Hilton Garden Inn RDU </h4>
            <p>Directions Distance <strong>Total Est. Time:</strong> 14 minutes <strong>Total  Est. Distance:</strong> 9.85 miles<br />
1: Start out going SOUTHEAST on RDU CENTER DR. 0.2  miles<br />
2: Make a U-TURN at RDU CENTER DR onto RDU CENTER DR. 0.2 miles<br />
3: Turn LEFT onto AVIATION PKWY. 0.2 miles<br />
4: Merge onto I-40 E toward RALEIGH. 3.8 miles<br />
...
<strong>Total Est. Time:</strong> 14 minutes<strong>Total  Est. Distance:</strong> 9.85 miles</p>
            <p align="center"><img src="../../images/maps/HiltonGarden.gif" alt="Map to Hotel" width="483" height="261" /></p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
