    ...
    <div id="yui-main">
      <div class="yui-b">
        ...
        <div id="secContent" class="yui-g">
          <h1>Past participating employers</h1>
          ...
          <div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                ...
                <li class="last">Past participating employers</li>
              </ul>
            </div>
          </div>
        <p>The following employers have participated in the externship program @ NC State.          We look forward to adding your organization to the list!</p>
<hr>
          <ul>
            <li>Baxter Healthcare</li>
            <li>              Brasfield &amp; Gorrie</li>
            <li>              Burt Bees</li>
            <li>              Caterpillar</li>
            <li>              Cook Medical</li>
            <li>              Credit Suisse</li>
            ...
            <li>              Fidelity</li>
            <li>              GE</li>
            <li>              Insteel Industries</li>
            <li>              Kimley-Horn</li>
            <li>              Mulkey Engineers</li>
            <li>              Netapp</li>
            <li>              Novartis</li>
            <li>              Novozymes</li>
            <li>              Oiles America</li>
