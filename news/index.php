...
$query_rsNewslist = "SELECT ID, heading, link, `view` FROM news";
$rsNewslist = mysql_query($query_rsNewslist, $connCareer) or die(mysql_error());
$row_rsNewslist = mysql_fetch_assoc($rsNewslist);
$totalRows_rsNewslist = mysql_num_rows($rsNewslist);
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            ...
            <table>
              ...
              <?php do { ?>
                <tr>
                  <td><?php echo $row_rsNewslist['ID']; ?></td>
                  <td><?php echo $row_rsNewslist['heading']; ?></td>
                  <td><?php echo $row_rsNewslist['link']; ?></td>
                  <td><?php echo $row_rsNewslist['view']; ?></td>
                </tr>
                <?php } while ($row_rsNewslist = mysql_fetch_assoc($rsNewslist)); ?>
            </table>
            <p>&nbsp;</p>
            <p>our resume and letter are your introduction. They are used when applying for internships, co-ops, and full-time jobs. When carefully and strategically prepared, they have the potential to lead to an interview. </p>
            <p>Since employers often spend &lt;1 minute reviewing these documents, your goal is to make an immediate positive impact. Customize your resume and letter for each employer, matching your accomplishments and interests to their needs. </p>
            <ul>
              <li><a href="#">What employers look for</a></li>
              <li><a href="#"> Sample resumes &amp; letters</a></li>
              <li><a href="#"> Resume worksheet - pdf </a></li>
              <li><a href="#"> Resume .ppt presentation [printable version]</a></li>
              <li><a href="#"> Resumes &amp; letters workshop </a></li>
              <li><a href="#"> Resume critiques</a></li>
              <li><a href="#"> References, recommendations, &amp; transcripts</a></li>
              <li><a href="#"> Portfolios &amp; work samples</a></li>
              <br />
            </ul>
            <br />
            <br />
