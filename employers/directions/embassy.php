...
<title>Embassy Suites near Crabtree</title>
<!-- InstanceEndEditable -->
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          <?php require_once('../../menus/EMPposting.php'); ?>
          <img src="../../images/pageimages/belltower.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Embassy Suites Raleigh -  Crabtree </h4>
            <p> Directions Distance <strong>Total Est. Time:</strong> 11 minutes <strong>Total  Est. Distance:</strong> 6.02 miles<br />
1: Start out going NORTH on CREEDMOOR RD /  NC-50 N toward SUGAR BUSH RD.  &lt;0.1 miles<br />
2: Make a U-TURN at SUGAR BUSH RD onto CREEDMOOR RD /  NC-50 S. 0.3 miles<br />
3: Turn LEFT onto GLENWOOD AVE / US-70 E / NC-50 S. 0.6  miles<br />
4: Take the I-440 S / RIDGE RD / OUTER BELTLINE ramp toward SANFORD. 0.1 miles<br /> 
5: Merge onto I-440 S / US-1 S. 2.9 miles<br /> 
6: Take the HILLSBOROUGH ST / NC-54 exit- EXIT 3-  toward MEREDITH COLL. 0.1 miles<br /> 
7: Turn SLIGHT LEFT to take the ramp toward  MEREDITH COLL / RALEIGH. &lt;0.1 miles <br />
8: Turn LEFT onto HILLSBOROUGH ST / NC-54. 1.3 miles<br />
9: Turn RIGHT onto DAN ALLEN DR. 0.2 miles<br />
10: Turn LEFT onto W DUNN AVE. &lt;0.1 miles<br />
11: End at <strong>North Carolina State Univ</strong><br />
<strong>Total Est. Time:</strong> 11 minutes<strong>Total  Est. Distance:</strong> 6.02 miles</p>
            <p align="center"><img src="../../images/maps/EmbassySuites.gif" alt="Map to Hotel" width="483" height="261" /></p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
