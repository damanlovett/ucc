...
<div id="maincontent">
  <h4><a name="content" id="content"></a>Resume Searches <strong>&nbsp;</strong></h4>
  <p> Conduct a resume search to invite candidates    to apply for an internship or job posting, sign up for an  on-campus interview,  attend an information session, or visit you at a career fair.<br />
    <span class="style15">Students appreciate and respond to your outreach.</span></p>
  <p class="style6">Get started</p>
  <ul>
    <li> Log into  ePACK, <a href="http://www.ncsu.edu/epack/employer">www.ncsu.edu/epack/employer</a></li>
    <li>Choose &quot;Student Search&quot; and select criteria</li>
    <li>Create a &ldquo;saved search&rdquo; for future use</li>
    <li>View and print resumes; contact students of interest directly </li>
  </ul>
  <p class="style6">Tips for success</p>
  <ul>
    <li>Include a variety of  different majors and graduation dates. </li>
    <li>  Be flexible about GPA: consider all accomplishments. </li>
    <li>Include freshmen and sophomores in your search for interns. </li>
    <li>Search by major <u><em>or</em></u>  keyword <u><em>or</em></u>  job preference.</li>
