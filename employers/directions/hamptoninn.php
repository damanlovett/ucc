    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Hampton Inn - RDU </h4>
            <p>Directions Distance <strong>Total Est. Time:</strong> 14 minutes <strong>Total  Est. Distance:</strong> 10.30 miles<br />
1: Start out going NORTHEAST on AIRPORT BLVD toward  AERIAL CENTER PKWY.  0.1 miles<br />
2: Merge onto I-40 E toward RALEIGH. 4.8 miles<br />
3: Keep RIGHT to take RALEIGH-CHAPEL HILL  EXPY via EXIT 289 toward RALEIGH NORTH / RALEIGH EAST. 3.4 miles<br />
4: RALEIGH-CHAPEL HILL EXPY becomes WADE AVE. 0.4 miles<br />
5: Turn RIGHT onto FAIRCLOTH ST. 0.5 miles<br />
&nbsp;6: Turn LEFT onto HILLSBOROUGH ST / NC-54. 0.6 miles<br />
&nbsp;7: Turn RIGHT onto DAN ALLEN DR. 0.2 miles<br />
&nbsp;8: Turn LEFT onto W DUNN AVE. &lt;0.1 miles<br />
9: End at <strong>North Carolina State Univ</strong><br />
<strong>Total Est. Time:</strong> 14 minutes<strong>Total  Est. Distance:</strong> 10.30 miles</p>
             <p align="center"><img src="../../images/maps/HamptonInnairport.gif" alt="Map to Hotel" width="483" height="261" /></p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
