...
<div class="breadCrumbHolder module">
          ...
          <ul>
            <li> Duties included administrative tasks in an
              office setting.</li>
            <li> Responsible for distributing a survey to current
              employees.</li>
            <li> The needs of recent hires were collected,
              documented, etc.</li>
            <li> I was involved in a variety of other activities,
              as needed.</li>
          </ul>
        </div>
      </div>
