    ...
    <div id="yui-main">
      <div class="yui-b">
        ...
        <div id="secContent" class="yui-g">
          <h1>MAJORS OF FAMOUS PEOPLE</h1>
          <div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                <ul>
                <li class="first"> <a href="#">Home</a> </li>
                <li> <a href="index.php">Choosing A Major</a></li>
                <li class="last"> Majors of Famous People</li>
              </ul>
            </div>
              </div>
...
<br>
          <table width="308" border="1">
            ...
            <tr>
              <td>Conan O'Brien</td>
              <td>American History &amp; Literature</td>
            </tr>
            <tr>
              <td>Colin Powell</td>
              <td>Geology</td>
