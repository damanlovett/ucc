            ...
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <table width="100%" align="center" cellpadding="3">
                ...
                <tr valign="baseline">
                  ...
                  <td><input name="title" type="text" class="smallformbox" value="" size="32"></td>
                </tr>
                <tr valign="baseline">
                  <td align="right" valign="middle" nowrap>Event date:</td>
                  <td><input name="eventdate" type="text" class="smallformbox" value="" size="32"> 
                  ex. October 26, 2006 </td>
                </tr>
                <tr valign="baseline">
                  <td align="right" valign="middle" nowrap>Check-in Begins: </td>
                  <td><input name="starttime" type="text" class="smallformbox" value="" size="32">
                  ex. 11:00 AM </td>
                </tr>
                <tr valign="baseline">
                  <td align="right" valign="middle" nowrap>Check-in Ends:</td>
