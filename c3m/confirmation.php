    ...
    <div id="yui-main">
      <div class="yui-b">
        ...
        <div id="secContent" class="yui-g">
          <h1>Career Fair Software Confirmation</h1>
          
<div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                <ul>
                <li class="first"> <a href="#">Home</a> </li>
                <li  class="last">Events and Career Fairs</li>
              </ul>
            </div>
          </div>

           <p>Thank you for your registration. We will be in contact to work on the details of the fair. Most details will need to be finalized a week before your event.            </p>
            <p>You will receive an email confirmation of your event shortly. Again thank you for fostering a partnership with the University Career Center. <br />
              </p>
        </div>
      </div>
    </div>
