    ...
    <div id="yui-main">
      <div class="yui-b">
        ...
        <div id="secContent" class="yui-g">
          <h1><span style='"Times New Roman"'>ACCEPTING AN OFFER</span></h1>
...
<div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                ...
                <li class="last">Accepting an offer</li>
              </ul>
            </div>
          </div>
          

          <p>This is a very important decision that should not
            be rushed.  If you need more time to make
            a decision, ask.  Employers will make every
            effort to give you the time you need, if they are able.  </p>
          <p>When you accept a job offer -- verbally or in
            writing -- it is a commitment.  It
            is not okay to continue interviewing in case there is a better
            opportunity.  (You would not want the
            employer to continue interviewing in case there is a better candidate!)  Remove yourself immediately from the interview
            process. </p>
          <p>How you handle yourself during this stage of the
            search is critical.  Employers
            communicate with one another.  A mistake
            could be costly to you as a new professional and can have far reaching
            consequences for NC State.  Employers
            have terminated relationships with universities as a result.&nbsp;</p>
          <p><b>We're here to help<br>
          </b>Consult with your <u><span style='color:#990000'><a
href="../../about/staff.php">career
            counselor</a></span></u> to discuss an offer, deadline, or decision.</p>
        </div>
      </div>
    </div>
    <div class="yui-b">
