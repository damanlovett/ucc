...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="maintable">
  ...
  <tr>
    ...
    <td width="581"><img src="../../images/banners/bannEmployer4.jpg" alt="" width="581" height="136" /></td>
  </tr>
  <!-- InstanceEndEditable -->
  <tr>
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          <?php require_once('../../menus/EMPleftnav.php'); ?>
          <img src="../../images/pageimages/fair.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
<div id="maincontent">
  <h4 align="left"><a name="content" id="content"></a>ePACK<strong></strong></h4>
  <p>Manage   all of your recruiting activities within ePACK -- post  internships and jobs, search for candidates,  request on-campus interviews and schedule information sessions. There is never a charge to use ePACK. </p>
  <p class="style1">Recruit interns &amp; entry-level hires </p>
  <ul>
    <li>Go to ePACK, <a href="http://www.ncsu.edu/epack/employer">www.ncsu.edu/epack/employer</a></li>
    <li>Register and receive a response with 24-48 hours</li>
    <li>See a <a href="../../pdfs/epackvisual_employers.pdf">visual overview</a> of ePACK </li>
    <li>View <a href="../../pdfs/epack_postings.pdf"> tips for posting jobs</a> in ePACK </li>
    <li>Questions? Ask Leslie Bowman, <a href="mailto:leslie_bowman@ncsu.edu">leslie_bowman@ncsu.edu</a></li>
    </ul>
    <p class="style1">Recruit co-ops, MBAs, &amp; experienced alumni</p>
    <ul>
    <li>Recruit students for co-op &ndash; <a href="http://www.ncsu.edu/co-op_ed/">Co-op</a></li>
    <li>Recruit MBAs for internships and jobs &ndash; <a href="http://www.ncsu.edu/co-op_ed/"></a><a href="http://mgt.ncsu.edu/mba/current_students/career_resources/"> MBA Career Resources</a></li>
    <li>Recruit experienced alumni for jobs &ndash; <a href="http://www.alumni.ncsu.edu/s/1209/index.aspx?sid=1209&amp;gid=1&amp;pgid=330">Alumni Association </a></li>
    </ul>
  <hr />
  <p class="style1">Note to third party recruiters    </p>
  <blockquote>
    <p>      Please email your positions; we are pleased to post them for you.<br />
          New graduates:  <a href="mailto:bridget_yarborough@ncsu.edu">bridget_yarborough@ncsu.edu</a><br />
          Experienced alumni: <a href="mailto:sue_simonds@ncsu.edu">sue_simonds@ncsu.edu</a></p>
    <p>&nbsp; </p>
  </blockquote>
  </div>
<!-- InstanceEndEditable --></td>
