...
<p>While ePACK is your number one source for finding internships
          ...
          <ul>
            <li>Career
              fairs (on campus and through consortiums)</li>
            <li>Law
              School Fair &amp; Health Career Expo</li>
            <li>Employer
              information sessions</li>
            <li>Career-related
              panels &amp; presentations</li>
            <li>Practice interviews &amp; resume critiques by employer</li>
          </ul>
        <p>Get started with <a href="http://www.ncsu.edu/epack">ePACK</a>!              </p>
        </div>
      </div>
    </div>
    <div class="yui-b">
