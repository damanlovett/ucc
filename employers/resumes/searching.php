...
<title>Successful Searching&nbsp;</title>
<!-- InstanceEndEditable -->
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="maintable">
  ...
  <tr>
    ...
    <td width="581"><img src="../../images/banners/bannEmployer3.jpg" alt="" width="581" height="136" /></td>
  </tr>
  <!-- InstanceEndEditable -->
  <tr>
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          ...
          <img src="../../images/pageimages/sample1.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
<div id="maincontent">
  <h4><a name="content" id="content"></a>Successful Searching<strong>&nbsp;</strong></h4>
  <p>IIn ePack, you have the opportunity to refine your resume search  to  identify a pool of candidates who meet your needs. </p>
  <ul>
    <li>Search liberally when possible.&nbsp; </li>
    <li>Consider May, summer and December graduates.</li>
    <li>Search by graduation date <u>vs</u>. status (i.e.  seniors) as some students have one status credit-wise and another  graduation-wise.&nbsp; </li>
    <li>Keep in mind that freshmen, sophomores, juniors, and  seniors (going on to grad school) are all interested in summer internships.</li>
    <li>Familiarize yourself with NC State&rsquo;s <a href="http://www.ncsu.edu/acad_depart.html">academic programs</a>.</li>
    <li>Include as many relevant majors as possible in your  search.</li>
    <li>Use the keyword search when seeking a specific skill  across several majors.</li>
    <li>Be flexible about GPA: consider all accomplishments.</li>
    <li>Contact students directly by email or by phone (in  the evening).&nbsp; This is a marketing  opportunity.&nbsp; Technical students prefer  technical contacts.&nbsp;&nbsp;&nbsp; </li>
    <li>Need a centralized place to conduct interviews?&nbsp; Consider <a href="../Interviewing/policies.php">on-campus interviews</a>.</li>
  </ul>
  <p>If the major you seek is in high demand &hellip;</p>
  <ul>
    <li>Consider other majors with experience or interest in  your field.</li>
    <li>Recruit for interns and cultivate a future full-time  hire.</li>
  </ul>
  <p> Consult with the <a href="../Quicklinks/staff.php">career counselor</a> who works with targeted majors for assistance. </p>
  <p>&nbsp;</p>
</div>
<!-- InstanceEndEditable --></td>
      </tr>
