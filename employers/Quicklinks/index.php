    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          ...
          <img src="../../images/pageimages/careerdoor.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
<div id="maincontent">
  <h4><a name="content" id="content"></a>Welcome</h4>
  <p>As many employers have already discovered, NC State students make great hires! <br />
    The UCC offers several ways to help you find your great hire. </p>
  <ul>
    <li><a href="../Interviewing/policies.php">On-campus interviews</a><strong> - </strong>[<a href="erecruiting.php">ePACK</a>] </li>
    <li>          <a href="../Interviewing/internshipjobs.php">Internship &amp; job postings</a> <strong> - </strong>[<a href="erecruiting.php">ePACK</a>]</li>
    <li>            <a href="../resumes/index.php">Resume searches</a><strong>  - </strong>[<a href="erecruiting.php">ePACK</a>] </li>
    <li><a href="../Interviewing/informationsessions.php">Employer information sessions</a><strong> - </strong>[<a href="erecruiting.php">ePACK</a>] </li>
    <li><a href="../Interviewing/careerfairs.php">Career fairs</a></li>
    <li><a href="../Marketing/studentorganization.php">Student organizations &amp; media</a><strong> </strong></li>
  </ul>
  <hr />
  <p>        Not sure what will work best for your needs?  Let <a href="staff.php">our staff</a> help.<br />
        We're glad you're here. <a href="mailto:carol_schroeder@ncsu.edu"></a><br />
    <br />
    <br />
  </p>
  </div>
