...
<title>Embassy Suites near Airport</title>
<!-- InstanceEndEditable -->
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Embassy Suites - Cary </h4>
            <p>Directions Distance <strong>Total Est. Time:</strong> 12 minutes <strong>Total  Est. Distance:</strong> 7.18 miles<br />
1: Start out going WEST on HARRISON OAKS BLVD  toward ENDEAVOR WAY.  &lt;0.1 miles<br />
2: Turn LEFT to stay on HARRISON OAKS BLVD.  0.3 miles<br />
3: Turn LEFT onto N HARRISON AVE. 0.1 miles<br />
4: Merge onto I-40 E toward RALEIGH. 1.3 miles<br />
5: Keep RIGHT to take RALEIGH-CHAPEL HILL  EXPY via EXIT 289 toward RALEIGH NORTH / RALEIGH EAST. 3.4 miles<br />
6: RALEIGH-CHAPEL HILL EXPY becomes WADE AVE. 0.4 miles<br />
7: Turn RIGHT onto FAIRCLOTH ST. 0.5 miles<br />
8: Turn LEFT onto HILLSBOROUGH ST / NC-54. 0.6 miles<br />
...
<strong>Total Est. Time:</strong> 12 minutes<strong>Total  Est. Distance:</strong> 7.18 miles</p>
            <p align="center"><img src="../../images/maps/EmbassySuitesairport.gif" alt="Map to Hotel" width="483" height="261" /></p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
