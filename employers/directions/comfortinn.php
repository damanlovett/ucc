    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Comfort Suites Arena </h4>
            <p>Directions Distance <strong>Total Est. Time:</strong> 9 minutes <strong>Total  Est. Distance:</strong> 3.54 miles <br />
1: Start out going NORTHEAST on HURRICAN ALLEY WAY  toward TRINITY RD.  0.1 miles<br />
2: Turn RIGHT onto TRINITY RD. 0.9 miles<br />
3: Turn RIGHT onto BLUE RIDGE RD. 0.2 miles<br />
4: Turn LEFT onto HILLSBOROUGH ST / NC-54. 1.9 miles<br />
5: Turn RIGHT onto DAN ALLEN DR. 0.2 miles<br />
6: Turn LEFT onto W DUNN AVE. &lt;0.1 miles<br />
7: End at <strong>North Carolina State Univ</strong><br />
<strong>Total Est. </strong>Time:</strong> 9 minutes<strong>Total  Est. Distance:</strong> 3.54 miles</p>
            <p align="center"><img src="../../images/maps/ComfortSuite.gif" alt="Map to Hotel" width="482" height="261" /></p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
