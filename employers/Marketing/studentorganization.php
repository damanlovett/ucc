...
<title>Student Organizations &amp; Media</title>
<!-- InstanceEndEditable -->
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          ...
          <img src="../../images/pageimages/sponsors.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Student Organizations &amp; Media</h4>
            <p align="left"><span class="style3">Let students know about your recruiting plans!</span></p>
            <p align="left"><span class="style1">Student organizations <br />
                </span><span class="style3"><br />
            
            Identify <a href="http://www.ncsu.edu/sorc/myOrgs/index.php">student organizations</a> of interest -- professional societies, honor societies, ethnic/multicultural groups, graduate student organizations, fraternities/sororities. Send an email or flyer,</span><span class="style3"> request a presentation, set up a professional development seminar, support  a project or event, invite a group for a site visit. The possibilities are endless.</span></p>
            <p align="left"><span class="style1">Student media 
              </span> </p>
            <ul>
              <li><a href="http://www.technicianonline.com/">Technician</a> --  student newspaper</li>
              <li>                  <a href="http://www.ncsu.edu/nubian/">Nubian Message</a> -- African-American student newspaper                  </li>
              <li><a href="http://www.ncsu.edu/agromeck/">Agromeck</a> -- student yearbook</li>
              <li>                  <a href="http://www.wknc.org/">WKNC</a> -- student radio station </li>
              <li> <a href="mailto:sara_concini@ncsu.edu">Job &amp; Internship Guide</a> -- UCC publication</li>
              </ul>
            <p>&nbsp;</p>
            </div>
        <!-- InstanceEndEditable --></td>
