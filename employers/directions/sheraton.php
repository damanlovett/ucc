...
<title>Sheraton Capital Center</title>
<!-- InstanceEndEditable -->
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Sheraton Raleigh </h4>
            <p>Directions Distance <strong>Total Est. Time:</strong> 7 minutes <strong>Total  Est. Distance:</strong> 3.11 miles<br />
1: Start out going SOUTH on S SALISBURY ST  toward W CABARRUS ST.  0.1 miles <br />
2: Turn RIGHT onto W LENOIR ST. 0.1 miles<br />
3: Turn LEFT onto S DAWSON ST / US-401 S /  US-70 E / NC-50 S. 0.1 miles<br /> 
4: Merge onto WESTERN BLVD toward MARTIN  LUTHER KING JR BLVD. 2.2 miles <br />
5: Turn RIGHT onto DAN ALLEN DR. 0.3 miles <br />
6: Turn RIGHT onto W DUNN AVE. &lt;0.1 miles<br />
7: End at <strong>North Carolina State Univ</strong><br />
<strong>Total Est. Time:</strong> 7 minutes<strong>Total  Est. Distance:</strong> 3.11 miles</p>
            <p align="center"><img src="../../images/maps/SheratonCapitalCenter.gif" alt="Map to Hotel" width="483" height="261" /></p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
      <tr>
