...
<title>On-campus Interviews</title>
<!-- InstanceEndEditable -->
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          ...
          <img src="../../images/pageimages/interview.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>On-campus Interviews  </h4>
            <p align="left">The UCC provides private interview rooms for your convenience. Create your own interview schedule ahead of time -- or use ePACK to allow students to sign up electronically. </p>
            <p align="left" class="style4">Get started</p>
            <ul>
              <li>Request an interview date: <a href="http://www.ncsu.edu/epack/employer">www.ncsu.edu/epack/employer</a>. <br />
                Choose &quot;Interview Schedules&quot; then &quot; New Schedule Request.&quot;<br />
                Refer to the <a href="calendar.php">recruiting calendar</a> when selecting your date.</li>
              <li>Receive a confirmation within 24-48 hours.</li>
              <li>Questions? Ask Bridget Yarborough, <a href="mailto:bridget_yarborough@ncsu.edu">bridget_yarborough@ncsu.edu</a>. </li>
            </ul>
            <p class="style4">Tips for success</p>
            <ul>
              <li>Conduct a <a href="../resumes/index.php">resume search</a> -- invite students to apply for your interview. </li>
              <li>Advertise your visit -- tap into the expertise of your recent hires from NC State! </li>
              <li>Advertise through targeted <a href="../Marketing/studentorganization.php">student organizations and media</a>. </li>
              <li>Schedule your interviews after a career fair, presentation to a student group, or an  <a href="informationsessions.php"> information session</a> arranged by the UCC. </li>
              </ul>
            <p>&nbsp;</p>
          </div>
        <!-- InstanceEndEditable --></td>
