...
<div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                ...
                <li class="last">Recommendations</li>
              </ul>
            </div>
          </div>
          <p>Letters of  recommendation are often required for graduate programs, scholarships, and  fellowships.&nbsp;  Since these letters  take time to compose, request them well in advance of deadlines.  Letters of recommendation are not required for  internships, co-ops or entry-level jobs.&nbsp; </p>
