...
<div class="breadCrumbHolder module">
            <div id="breadCrumb" class="breadCrumb module">
                ...
                <li class="last">Practice interviews </li>
              </ul>
            </div>
          </div>
...
href="http://www.jobweb.com/Interview/help.aspx?id=626&amp;terms=mock+interview+rubric">Interview rubric</a></li>
          ...
          <ul>
            <li> Ask
                  a professional at work or in the community for a practice interview. </li>
            <li> Watch <a href="http://www.ncsu.edu/epack">ePACK</a> for practice interviews offered by  employers. </li>
            <li> Schedule
                    a practice interview with your <a
