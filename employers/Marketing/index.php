...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="maintable">
  ...
  <tr>
    ...
    <td width="581"><img src="../../images/banners/bannEmployer.jpg" alt="" width="581" height="136" /></td>
  </tr>
  <!-- InstanceEndEditable -->
  <tr>
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        <td width="195" align="left" valign="top" id="leftnav2"><!-- InstanceBeginEditable name="leftnav" -->
          <?php virtual('/career/menus/EMPleftnav.php'); ?>
          <img src="../../images/pageimages/parents3.jpg" alt="" width="195" height="165" />
          <p></p>
        <!-- InstanceEndEditable --></td>
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>About NC State </h4>
            <p><a href="http://www.ncsu.edu/aboutncstate.html">About NC  State</a> <br />
              Looking for talent? You have come to the right place. NC State is a recognized leader in science, technology, and engineering. </p>
            <p><a href="http://www.ncsu.edu/reg_records/calendars/index.html">Academic calendar</a><br />
              Know the students' schedule before you make your recruiting plans.</p>
            <p>                <a href="http://www.ncsu.edu/colleges_schools.html">Colleges</a> / <a href="http://www.ncsu.edu/acad_depart.html">Departments</a> / <a href="http://www.ncsu.edu/academics/degrees-programs/index.php">Degree Programs</a> <br />
                Find links to degree programs, curriculum, faculty, and areas of research.</p>
            <p><a href="https://www.regrec.ncsu.edu/scripts/RegRec/ada_dgtt.pl?college=ALL_DEG">                </a>
                <a href="http://www2.acs.ncsu.edu/upa/enrollmentdata/index.htm">Enrollment  statistics by major</a><br />
 What is the profile of students in each major?</p>
            <p>                <a href="http://www2.acs.ncsu.edu/upa/degrees/index.htm">Graduation  statistics by major</a><br />
 How many students graduate in each major?</p>
            <p><a href="http://www.ncsu.edu/diversity/index.php">Diversity</a><br />
              Connect with diverse student organizations and programs.</p>
            <p><a href="international.php">International students</a><br />
              Learn the details involved with hiring international students. </p>
            <p><a href="studentorganization.php">Student organizations &amp; media</a><br />
Identify specific student groups or  advertise broadly through student media. </p>
            <p><a href="../Quicklinks/support.php">Career Center support </a>&nbsp;<br />
              Wondering how you can help the Career Center? </p>
            <p>&nbsp;            </p>
          </div>
        <!-- InstanceEndEditable --></td>
      </tr>
