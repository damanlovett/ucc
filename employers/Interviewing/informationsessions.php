...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="maintable">
  ...
  <tr>
    ...
    <td width="581"><img src="../../images/banners/bannEmployer2.jpg" alt="" width="581" height="136" /></td>
  </tr>
  <!-- InstanceEndEditable -->
  <tr>
    ...
    <td colspan="2"><table width="760" border="0" align="center" cellpadding="0" cellspacing="0" class="contenttable">
      <tr><a name="links" id="links"></a>
        ...
        <td align="left" valign="top"><!-- InstanceBeginEditable name="MainContent" -->
          <div id="maincontent">
            <h4><a name="content" id="content"></a>Employer Information Sessions</h4>
            <p align="left">Set up an information session through the UCC prior to on-campus interviews or career fairs to generate interest with  targeted students. These may also be arranged through <a href="http://www.ncsu.edu/sorc/myOrgs/index.php">student organizations</a> or <a href="http://www.ncsu.edu/academics/departments-a-z/index.php">academic departments</a>. </p>
            <p align="left" class="style6">Get started </p>
            <ul>
              <li>Select a date: <a href="calendar.php">recruiting calendar</a></li>
              <li>Contact the UCC : <a href="mailto:career_center@ncsu.edu">career_center@ncsu.edu</a><br />
                We will reserve a room   on campus for your session. </li>
              </ul>
            <p class="style6">Tips for success</p>
            <ul>
              <li>Advertise through <a href="http://www.ncsu.edu/academics/departments-a-z/index.php">academic departments</a> of interest. </li>
              <li>Advertise through targeted <a href="../Marketing/studentorganization.php">student organizations and  media</a>. </li>
              <li>Invite students to attend through <a href="http://www.ncsu.edu/epack/employer">ePACK</a>.</li>
              <li>Bring a recent graduate or current intern/co-op to the session.</li>
              <li>Use University Catering, 919.515.2023 or other vendor  (refreshments are suggested.) </li>
              <li>Consult a <a href="../Quicklinks/staff.php">career counselor</a> for additional strategies. </li>
              </ul>
            <p>&nbsp;</p>
            </div>
        <!-- InstanceEndEditable --></td>
