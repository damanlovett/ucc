...
href="http://www.ncsu.edu/co-op_ed/employers/">Post co-ops through the Co-op Office</a>.</li>
          ...
          <hr />
          <p><b>Tips for
              outstanding experiences</b></p>
          <ul>
            <li>Challenging work assignments</li>
            <li>Supportive work environment</li>
            <li>Clearly stated expectations</li>
            <li>Active supervision and mentoring </li>
            <li>Opportunities to interact with other students</li>
            <li>Inclusion in meetings or events, when possible</li>
            <li>Housing assistance or guidance, if out of town</li>
          </ul>
        </div>
      </div>
    </div>
